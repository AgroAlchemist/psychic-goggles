...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>AgroAlchemist - One Nation One Market</title>
      ...
      <div class="container px-0">
        <nav class="navbar navbar-light bg-white navbar-expand-xl">
          <a href="index.html" class="navbar-brand"
            ><h1 class="text-primary display-6">AgroAlchemist</h1></a
          >
          <button
      ...
      <div class="container py-5">
        <div class="row g-5 align-items-center">
          <div class="col-md-12 col-lg-7">
            <h4 class="mb-3 text-secondary">Welcome to....</h4>
            <h1 class="mb-5 display-3 text-primary">One Nation One Market</h1>
          ...
          <div class="col-md-12 col-lg-5">
            ...
            >
              <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item rounded">
                  <img
                    src="img/hero-seed.jpg"
                    class="img-fluid w-100 h-100 rounded"
                    alt="Second slide"
                  />
                  <a href="#" class="btn px-4 py-2 text-white rounded">Seeds</a>
                </div>
                <div class="carousel-item rounded">
                  <img
                    src="img/hero-rental.jpg"
                    class="img-fluid w-100 h-100 rounded"
                    alt="Second slide"
                  />
                  <a href="#" class="btn px-4 py-2 text-white rounded"
              ...
              <ul class="nav nav-pills d-inline-flex text-center mb-5">
                <li class="nav-item">
                  <a
                    ...
                    href="#tab-1"
                  >
                    <button class="text-dark" style="width: 130px">
                      Crop Planning
                    </button>
                  </a>
                </li>
                <li class="nav-item">
                  <a
                    ...
                    href="#tab-2"
                  >
                    <span class="text-dark" style="width: 130px">Seeds</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a
                ...
                <li class="nav-item">
                  <a
                    ...
                    href="#tab-5"
                  >
                    <span class="text-dark" style="width: 130px">Rentals</span>
                  </a>
                </li>
              </ul>
            </div>
